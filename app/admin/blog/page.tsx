  ...
  return (
    <div className="space-y-10">
      <div className="flex justify-between items-end">
        ...
        <Link href="/admin/blog/new" className="btn-primary h-14 px-8 text-[10px] font-bold uppercase flex items-center gap-3 shadow-xl shadow-brand/10">
                ...
                <tr key={post.id} className="hover:bg-surface/30 transition-colors group">
                  ...
                  <td className="px-10 py-8 text-right">
                    <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <Link href={`/admin/blog/${post.id}`} className="p-3 bg-surface hover:bg-emerald-500 hover:text-white rounded-lg transition-all text-text-muted"><Edit2 size={16} /></Link>
