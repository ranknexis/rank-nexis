      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-stroke pb-8">
         <div className="space-y-2">
            ...
            <h1 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-text-primary leading-tight">
               Administrative <span className="text-brand">Node.</span>
            </h1>
         ...
         <div className="flex gap-4">
            <Link href="/admin/leads" className="btn-outline h-12 px-6 text-xs font-bold uppercase rounded-xl flex items-center gap-2 hover:bg-surface duration-300 transition-all shadow-sm">
               Review Leads
            </Link>
            <Link href="/admin/settings" className="btn-primary h-12 px-6 text-xs font-bold uppercase rounded-xl flex items-center gap-2 shadow-premium duration-300 transition-all">
               System Settings
            </Link>
         </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
         ...
         <div className="lg:col-span-8 bg-white rounded-[2rem] border border-stroke p-8 md:p-10 space-y-8 shadow-sm hover:shadow-premium transition-all duration-500 relative overflow-hidden grain">
            <div className="flex justify-between items-center">
               ...
               <Link href="/admin/leads" className="text-xs font-bold uppercase text-brand hover:underline flex items-center gap-1.5 tracking-wider">
         ...
         <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-brand rounded-[2rem] p-8 text-white space-y-6 relative overflow-hidden shadow-premium grain">
               ...
               <div className="grid grid-cols-2 gap-4">
                   <Link href="/admin/work" className="flex flex-col items-center gap-3 p-4 bg-white/10 hover:bg-white/20 transition-all rounded-xl border border-white/10 duration-300">
                      <Briefcase size={22} />
                      <span className="text-[10px] font-bold uppercase tracking-wider">New Case Study</span>
                   </Link>
                   <Link href="/admin/blog" className="flex flex-col items-center gap-3 p-4 bg-white/10 hover:bg-white/20 transition-all rounded-xl border border-white/10 duration-300">
                      <FileText size={22} />
