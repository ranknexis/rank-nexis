...
export default function WorkEditor({ initialData }: { initialData: any }) {
  ...
  const handleSave = async () => {
    ...
    if (res.success) {
      ...
      if (!initialData?.id && res.data) router.push(`/admin/work/${res.data.id}`);
    } else {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
      ...
      <div className="lg:col-span-3 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <Link href="/admin/work" className="w-full h-16 bg-white border border-stroke text-text-muted rounded-2xl text-[11px] font-bold uppercase hover:bg-surface transition-all flex items-center justify-center gap-3">
