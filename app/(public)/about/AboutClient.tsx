      ...
      <main className="grain">
        ...
        <section className="relative py-12 md:py-24 overflow-hidden">
          ...
          <div className="container-max relative z-10 text-center space-y-4 md:space-y-12">
            ...
            >
              ...
              <p className="text-text-secondary max-w-3xl mx-auto text-base md:text-2xl font-medium leading-relaxed px-4 md:px-0">
                {hero.subtext}
              </p>
            </motion.div>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-center">
                 <div className="space-y-6 md:space-y-12">
                    <div className="space-y-3 md:space-y-6">
                       ...
                       <h2 className="text-xl md:text-5xl font-bold tracking-tight leading-tight uppercase">{narrative.heading} <br /><span className="text-brand">{narrative.headingAccent}</span></h2>
                    </div>
                    
                    <div className="space-y-4 md:space-y-8 prose prose-lg md:prose-xl max-w-none text-text-secondary font-medium leading-relaxed antialiased" dangerouslySetInnerHTML={{ __html: narrative.body }} />

                    <div className="flex flex-wrap gap-6 md:gap-16 pt-6 md:pt-12 border-t border-stroke">
                       {getSectionData(sectionsMap, "growth_stats", { items: [
                        ...
                        <div key={i} className="space-y-2">
                           <p className="text-3xl md:text-5xl font-bold text-brand tracking-tighter">{stat.title}</p>
                  ...
                  <div className="relative group p-4">
                     <div className="aspect-square glass rounded-2xl md:rounded-[4rem] overflow-hidden relative shadow-premium grain border border-stroke">
                        <Image 
        ...
        <section className="py-12 md:py-24 bg-white">
           <div className="container-max space-y-6 md:space-y-16">
              <div className="flex flex-col md:flex-row justify-between items-end gap-4 md:gap-8 border-b border-stroke pb-6 md:pb-12 px-4 md:px-0">
                 <div className="space-y-2 md:space-y-4">
                    <p className="text-[11px] font-bold uppercase tracking-[0.4em] text-brand">The Collective</p>
                    <h2 className="text-xl md:text-5xl font-bold tracking-tight uppercase leading-none">High-Agency <br /><span className="text-brand">Expertise.</span></h2>
                 </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 px-4 md:px-0">
                 {teamMembers.map((member, i) => (
                    <motion.div
                       ...
                       className="group relative aspect-[3/4] rounded-2xl md:rounded-[2.5rem] overflow-hidden border border-stroke shadow-sm hover:shadow-premium transition-all duration-700 will-change-gpu"
                    >
                       <Image 
        ...
        <section className="py-12 md:py-32 bg-white relative px-4 md:px-6 overflow-hidden grain text-center">
          ...
          <div className="container-max relative z-10 space-y-6 md:space-y-16">
            <div className="space-y-3 md:space-y-8">
               <p className="text-[11px] font-bold uppercase tracking-wider text-brand">Connect With Us</p>
                  <h2 className="text-xl md:text-5xl font-bold tracking-tight uppercase leading-tight">
                    Our <span className="text-brand text-xl md:text-5xl block mt-1.5 md:mt-4 tracking-tight">Expertise.</span>
                  </h2>
            </div>
            
            <p className="text-text-secondary max-w-2xl mx-auto text-sm md:text-2xl font-medium leading-relaxed antialiased">
