      ...
      <main className="grain">
        ...
        <section className="py-16 md:py-48 bg-white text-center relative px-4 md:px-6 overflow-hidden grain">
           ...
           <div className="flex justify-center px-4">
              <Link href="/contact" className="btn-primary w-full sm:w-auto h-16 md:h-20 px-10 md:px-16 text-[10px] font-bold uppercase tracking-[0.4em] group shadow-premium inline-flex items-center justify-center gap-3">
