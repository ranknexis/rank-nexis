    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-surface/30">
        ...
        <div className="container-max">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold uppercase tracking-tighter leading-tight text-text-primary">
              {study.title}
            </h1>

            <div className="flex flex-wrap gap-8 py-8 border-y border-stroke">
              <div className="space-y-1">
                ...
                <p className="text-lg font-bold text-text-primary">{study.client}</p>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] font-bold uppercase text-text-muted flex items-center gap-2">
                  <Tag size={12} className="text-brand" /> Service
                </p>
                <p className="text-lg font-bold text-text-primary">{study.tag}</p>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] font-bold uppercase text-text-muted flex items-center gap-2">
      ...
      <section className="relative -mt-10 pb-24">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            >
              <div className="p-10 glass rounded-[2.5rem] shadow-premium border border-stroke space-y-4">
                <div className="w-12 h-12 bg-brand/10 rounded-2xl flex items-center justify-center">
                  <BarChart3 className="text-brand" size={24} />
                </div>
                <div className="space-y-1">
                  <h3 className="text-6xl font-bold tracking-tighter text-text-primary">{study.stats}</h3>
      ...
      <section className="py-24 space-y-32">
        ...
        <div className="container-max grid grid-cols-1 lg:grid-cols-2 gap-24">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-3xl font-bold uppercase tracking-tight">The Project Overview</h2>
            </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-3xl font-bold uppercase tracking-tight">The Core Challenges</h2>
            </div>
            <p className="text-lg text-text-secondary leading-relaxed font-medium">
              {study.challenge}
            </p>
          ...
          <div className="container-max relative z-10">
            <div className="max-w-3xl space-y-10">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-4xl font-bold uppercase tracking-tight text-text-primary">Our Strategic Solution</h2>
              </div>
              <p className="text-2xl text-text-primary leading-tight font-medium">
                {study.solution}
              </p>
            </div>
          </div>
        ...
        <div className="container-max grid grid-cols-1 lg:grid-cols-2 gap-24">
          ...
          >
            <h2 className="text-3xl font-bold uppercase tracking-tight">Project Execution</h2>
            <div className="space-y-4">
              {study.execution.map((step, i) => (
                <motion.div 
                  key={i}
                  variants={itemVariants}
                  className="flex items-start gap-4 p-6 rounded-3xl bg-surface border border-stroke hover:border-brand/30 transition-colors group"
                >
                  <span className="text-xs font-bold text-brand/40 group-hover:text-brand transition-colors">0{i+1}</span>
                  <p className="text-lg font-bold text-text-primary">{step}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="space-y-12"
          >
            <h2 className="text-3xl font-bold uppercase tracking-tight text-brand">Final Results</h2>
            <div className="space-y-4">
              {study.results.map((result, i) => (
                <motion.div 
                  key={i}
                  variants={itemVariants}
                  className="flex items-center gap-6 p-6 rounded-3xl glass shadow-premium border border-stroke"
                >
      ...
      <section className="py-32 border-t border-stroke text-center">
        <div className="container-max space-y-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <button className="btn-primary h-20 px-16 text-[11px] font-bold uppercase shadow-premium group">
              Start Your Project <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="btn-outline h-20 px-16 text-[11px] font-bold uppercase glass">
              Explore More Work
            </button>
          </div>
        </div>
