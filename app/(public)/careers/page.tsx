    ...
    <div className="min-h-screen bg-white text-text-primary">
      <main className="grain">
        ...
        <section className="relative pt-20 pb-16 md:pt-48 md:pb-32 overflow-hidden border-b border-stroke">
           ...
           <div className="container-max relative z-10 text-center space-y-6 md:space-y-12">
              <div className="space-y-6 px-4 md:px-0">
                 ...
                 <h1 className="text-2xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight uppercase">
                   {hero.heading} <br /> <span className="text-brand">{hero.headingAccent}</span>
                 </h1>
                 <p className="text-text-secondary max-w-2xl mx-auto text-lg md:text-2xl font-medium leading-relaxed">
                   {hero.subtext}
                 </p>
              </div>
           </div>
        ...
        <section className="py-16 md:py-24 bg-white text-text-primary relative overflow-hidden border-t border-stroke grain px-4 md:px-0">
           <div className="absolute top-0 left-0 w-full h-full bg-brand/[0.01] -z-10" />
           <div className="container-max grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              <div className="space-y-8 md:space-y-12">
                 <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="text-text-secondary text-base md:text-lg font-medium leading-relaxed max-w-xl antialiased" dangerouslySetInnerHTML={{ __html: culture.body || "We are looking for creative and hardworking people to join our high-performing team. We pride ourselves on building premium digital solutions for growing brands." }} />
                 </div>
              ...
              <div className="relative group p-2">
                 <div className="absolute inset-0 bg-brand/5 blur-3xl group-hover:bg-brand/10 transition-all rounded-3xl -z-10" />
                 <div className="aspect-[4/3] rounded-3xl md:rounded-[2.5rem] overflow-hidden grain shadow-premium border border-stroke bg-white relative">
                    <Image src={culture.imageUrl && !culture.imageUrl.includes('unsplash') ? culture.imageUrl : "/images/careers_culture.png"} alt="Team Session" fill className="object-cover transition-all duration-700 group-hover:scale-105" />
