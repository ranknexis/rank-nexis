                 ...
                 <div className="space-y-8">
                    ...
                    <div className="flex flex-wrap gap-12 pt-4">
                       ...
                       <div className="flex items-center gap-3">
                          ...
                          <span className="text-lg font-bold uppercase tracking-tight">Competitive Salary</span>
                       </div>
                    </div>
                 </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
                 ...
                 <div className="lg:col-span-7 space-y-24">
                    ...
                    {job.responsibilities?.length > 0 && (
                      <div className="space-y-10">
                         <h2 className="text-3xl font-bold uppercase tracking-tighter">Key <span className="text-brand">Responsibilities.</span></h2>
                         <div className="space-y-6">
                            {job.responsibilities.map((res: string) => (
                               <div key={res} className="flex items-start gap-4 p-6 glass border border-stroke rounded-2xl group hover:border-brand transition-all">
                                  <CheckCircle2 className="text-brand shrink-0 mt-1" size={20} />
                                  <p className="text-sm font-bold uppercase leading-relaxed text-text-muted group-hover:text-text-primary">{res}</p>
                               </div>
                            ))}
                         </div>
                      </div>
                 ...
                 <aside className="lg:col-span-5 lg:sticky lg:top-32 h-fit">
                    <div className="corporate-card grain p-12 space-y-10 shadow-premium border-stroke hover:border-brand transition-all duration-700 bg-white relative overflow-hidden">
