    ...
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-stroke pb-8">
        <div className="space-y-4">
          ...
          <h1 className="text-4xl font-bold uppercase tracking-tighter text-text-primary">Job <span className="text-brand">Applications.</span></h1>
          ...
          <table className="w-full text-left table-fixed">
            <thead>
              <tr className="border-b border-stroke bg-surface/50">
                <th className="px-8 py-5 text-[10px] font-bold uppercase text-text-muted tracking-widest">Candidate</th>
                <th className="px-8 py-5 text-[10px] font-bold uppercase text-text-muted tracking-widest">Applied Role</th>
                <th className="w-48 px-8 py-5 text-[10px] font-bold uppercase text-text-muted tracking-widest">Submitted On</th>
                <th className="w-44 px-8 py-5 text-[10px] font-bold uppercase text-text-muted tracking-widest text-right">Actions</th>
              </tr>
            </thead>
              ...
              {applications.length === 0 ? (
                ...
                applications.map((app) => (
                  <tr key={app.id} className="hover:bg-surface/30 transition-colors group">
                    ...
                    <td className="px-8 py-5 text-[10px] font-bold uppercase text-text-muted">
                      <div className="flex items-center gap-2">
